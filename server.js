...
if (process.env.TELEGRAM_TOKEN) {
    ...
    // === НАЛАШТУВАННЯ КНОПКИ "MENU" (СПИСОК КОМАНД) ===
    bot.setMyCommands([
        ...
        console.log("✅ Команди меню оновлено в Telegram");
    });
}
        ...
        if (content.trim().startsWith('/post')) {
            ...
            try {
                ...
                await NewsPost.create({
                    ...
                    type: msg.photo ? 'photo' : 'text', readBy: []
                });
